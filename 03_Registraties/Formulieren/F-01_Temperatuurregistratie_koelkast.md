# F-01 · Temperatuurregistratie medicatiekoelkast
...
| Dag | Temp (°C) | Binnen 2–8? | Paraaf | Actie bij afwijking |
|---|---|---|---|---|
| 1 |  | ja / nee |  |  |
| 2 |  | ja / nee |  |  |
| 3 |  | ja / nee |  |  |
...
**Maandafsluiting** — aantal dagen geregistreerd: ____ · aantal afwijkingen: ____ · paraaf arts: ________

---

### Ingevuld — juli 2026 (start registratie)

| Dag | Temp (°C) | Binnen 2–8? | Paraaf | Opmerking |
|---|---|---|---|---|
| 26 |  | ja / nee |  | *Start van de schriftelijke registratie. De dagelijkse controle werd al uitgevoerd, maar niet vastgelegd; dit is bij de eigen consistentiecontrole geconstateerd en per vandaag hersteld.* |
