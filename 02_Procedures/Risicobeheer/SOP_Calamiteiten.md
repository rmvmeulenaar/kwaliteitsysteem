...
Deze SOP beschrijft de procedures voor het omgaan met calamiteiten en noodsituaties in de kliniek. Dit protocol is van toepassing op alle medewerkers en moet de veiligheid van patiënten, medewerkers en bezoekers waarborgen.

## 2. Definities en afkortingen

- **BHV**: Bedrijfshulpverlening
- **AED**: Automatische Externe Defibrillator
- **EHAK**: Eerste Hulp bij Arbeidsongevallen
...
### c. Stroomuitval
1. Noodstroomvoorziening controleren.
2. Essentiële apparatuur handmatig resetten.
3. Indien storing langer dan 30 minuten duurt, patiënten informeren.
4. Kritieke behandelingen uitstellen of veilig afronden.
...
5. Registratie en evaluatie van het incident.
...
- Incidentformulieren invullen en bespreken in teamvergadering.
- Analyse van de oorzaak en effectiviteit van de respons.
- Implementatie van verbetermaatregelen.

## 10. Documentatie en registratie-eisen

- Noodincidenten registreren in het calamiteitenlogboek.
- Onderhoud en controles van apparatuur documenteren.
- Trainingen en oefeningen registreren.

## 11. Referenties naar relevante wet- en regelgeving

- Arbowet en richtlijnen voor bedrijfshulpverlening.
- RIVM-richtlijnen voor medische noodsituaties.
- NEN-EN 15224: Kwaliteitsmanagement in de gezondheidszorg.
